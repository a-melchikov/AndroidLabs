package com.melchikov.mycityapp.ui
    ...
    NavHost(
        ...
        composable("detail/{recommendationId}") { backStackEntry ->
            val recommendationId =
                backStackEntry.arguments?.getString("recommendationId")?.toIntOrNull() ?: 0
            DetailScreen(navController = navController, recommendationId = recommendationId)
        }
    }
}
